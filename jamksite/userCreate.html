                ...
                <div class="col-lg-6">
                    ...
                    <form>
                        <div class="input-group">
                            ...
                            <input id="client-name" type="text" class="form-control" name="client-name" placeholder="Name">
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-fw fa-calendar-plus-o"></i></span>
                            <input id="start-date" type="date" class="form-control" name="start-date" placeholder="Start date">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-fw fa-calendar-times-o"></i></span>
                            <input id="end-date" type="date" class="form-control" name="end-date" placeholder="End date">
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-fw fa-user-plus"></i></span>
                            <input id="num-guests" type="text" class="form-control" name="num-guests" placeholder="Number of Guests">
                        </div>
                        <br>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-fw fa-phone"></i></span>
                            <input id="client-phone" type="text" class="form-control" name="client-phone" placeholder="Phone Number">
                        </div>
                        <br>
                        <div class="input-group">
                        ...
                        <div class="form-group" align="right">
                            <button type="button" id="userCreateSubmit" class="btn btn-primary btn-block">Submit</button>
                        </div>
                    </form>
                </div>
                <div class="col-lg-6">
                    <h1 class="page-header">Confirmation</h1>
                    <h5>Thank you. Your reservation has been placed.</h5>
                    <strong>Your confirmation number is: 999</strong>
                    <br>
